...
config['frame_length'] = 1000 # number of samples per step (i.e. per 'char')
config['seq_length'] = 100  # number of chars in the sequence
...
config['output_filename'] = '1000_100.wav'
config['secs_to_generate'] = 30

config['hdf5_file'] = '1000_100.hdf5'  # hdf5 file with Fuel format
