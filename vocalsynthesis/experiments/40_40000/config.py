...
config['frame_length'] = 40 # number of samples per step (i.e. per 'char')
config['seq_length'] = 40000  # number of chars in the sequence
...
# mostly for train.py
config['batch_size'] = 4  # number of examples taken per each update
